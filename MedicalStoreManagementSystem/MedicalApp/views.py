...
from MedicalApp.models import Company, CompanyBank, Medicine, MedicalDetail, CompanyAccount, Employee, EmployeeBank, EmployeeSalary, \
    CustomerRequest, Bill, BillDetail
from MedicalApp.serializers import CompanySerializer, CompanyBankSerializer, MedicalDetailSerializer, MedicalDetailSerializerSimple, \
    CompanyAccountSerializer, EmployeeBankSerializer, EmployeeSalarySerializer, CustomerSerializer, BillSerializer, BillDetailSerializer,\
        CustomerRequestSerializer, MedicalDetailSerializer, EmployeeSerializer, CompanySerializer, MedicineSerializer
...
class MedicineViewSet(viewsets.ViewSet):
    ...
    def list(self,request):
        ...
        for medicine in medicine_data:
            #Accessing All the Medicine Details of Current Medicine ID
            medicine_detail=MedicalDetail.objects.filter(medicine_id=medicine["id"])
            medicine_detail_serializers=MedicalDetailSerializerSimple(medicine_detail,many=True)
            medicine["medicine_detail"]=medicine_detail_serializers.data
    ...
    def retrieve(self,request,pk=None):
        ...
        medicine_detail_serializers = MedicalDetailSerializerSimple(medicine_detail, many=True)
        serializer_data["medicine_details"] = medicine_detail_serializers.data
    ...
    def update(self,request,pk=None):
        ...
        for salt_detail in request.data["medicine_detail"]:
            if salt_detail["id"]==0:
...
class GenerateBillViewSet(viewsets.ViewSet):
    ...
    def create(self, request):
        ...
        serializer3 = BillDetailSerializer(data=medicine_details_list, many=True,
...
class HomeApiViewset(viewsets.ViewSet):
    ...
    def list(self,request):
        ...
        bill_details_today=BillDetail.objects.filter(added_on__date=current_date)
        profit_amt_today=0
        sell_amt_today=0
        buy_amt_today=0
